...
#
# Created: Fri Mar 13 01:15:57 2015
...
class Ui_PyAlarmWindow(QtGui.QWidget, PyAlarm):
    ...
    def setupUi(self, PyAlarmWindow):
        ...
        self.find_album_button.setGeometry(QtCore.QRect(5, 135, 91, 31))
        ...
        self.minute_label.setGeometry(QtCore.QRect(140, 39, 61, 20))
        ...
        self.minute_spinbox.setGeometry(QtCore.QRect(140, 59, 81, 51))
        font = QtGui.QFont()
        font.setPointSize(40)
        ...
        self.colon_label.setGeometry(QtCore.QRect(112, 60, 16, 51))
        font = QtGui.QFont()
        font.setPointSize(40)
        self.colon_label.setFont(font)
        self.colon_label.setObjectName("colon_label")
        self.set_alarm_label = QtGui.QLabel(PyAlarmWindow)
        self.set_alarm_label.setGeometry(QtCore.QRect(25, 5, 181, 31))
        font = QtGui.QFont()
        font.setPointSize(25)
        font.setUnderline(True)
        self.set_alarm_label.setFont(font)
        self.set_alarm_label.setAlignment(QtCore.Qt.AlignCenter)
        self.set_alarm_label.setObjectName("set_alarm_label")
        self.random_song_label = QtGui.QLabel(PyAlarmWindow)
        self.random_song_label.setGeometry(QtCore.QRect(10, 120, 91, 20))
        font = QtGui.QFont()
        font.setUnderline(True)
        ...
        self.specific_song_label.setGeometry(QtCore.QRect(135, 120, 91, 20))
        font = QtGui.QFont()
        font.setUnderline(True)
    ...
    def retranslateUi(self, PyAlarmWindow):
        ...
        self.set_alarm_label.setText(QtGui.QApplication.translate("PyAlarmWindow", "Set Alarm", None, QtGui.QApplication.UnicodeUTF8))
