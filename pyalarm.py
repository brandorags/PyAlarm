"""
Name: pyalarm.py (Mac version)
Author: Brandon Ragsdale
Date: 7/5/2015
Description: This program is an alarm clock that will play a random
song from a user's iTunes library and increment the volume at a set rate
"""
